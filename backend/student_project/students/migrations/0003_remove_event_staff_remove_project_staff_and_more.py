...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('students', '0002_staff_remove_organization_employee_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event',
            name='participants',
            field=models.ManyToManyField(related_name='events', to='students.customuser'),
        ),
        migrations.AddField(
            model_name='project',
            name='participants',
            field=models.ManyToManyField(related_name='projects', to='students.customuser'),
        ),
