                ...
                <div className="wrapper">
                    <div className="search">
                        {/* <div className="search-area">
                            <input type="search" name="" id="" className="search-area__bar" placeholder="Поиск по проектам" />
                         ...
                         <div className="search-top">
                            <Link className=" right__button" id="search-top__create-btn" to="/create/project">
                                Создать
                            </Link>
                        </div>
